...
// Lógica para el Indicador de Demanda [cite: 112, 258-261]
...
// Lógica para la Etiqueta de Fase [cite: 129, 275, 278-279]
    ...
    <div class="p-4 flex-grow">
      ...
      <div class="flex justify-around text-center">
        <div>
          ...
          <p class="text-2xl font-bold text-red-600">${{ product.costo.toFixed(2) }}</p>
        </div>
        <div>
          <p class="text-sm text-gray-500">Precio Venta</p>
          <p class="text-2xl font-bold text-green-600">${{ product.precio.toFixed(2) }}</p>
        </div>
      </div>
    </div>
